PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    ro.com.google.clientidbase=android-topwell \
    ...
    ro.config.ringtone_sim2=SitarVsSitar.ogg \
    ...
    ro.ksc5601_write=0 \
    ro.kt_base_bug=1 \
    ro.kt_battery_percent_default=1 \
    ro.kt_brightness_off=1 \
    ro.kt_cal_view_type=4 \
    ro.kt_camera_lighting=1 \
    ro.kt_camera_perview_type=1 \
    ro.kt_camera_storage_support=0 \
    ro.kt_camera_time_stamp=1 \
    ro.kt_camera_volume_key=0 \
    ro.kt_capture_mirror_switch=1 \
    ro.kt_fingerprint_action=1 \
    ro.kt_flip_to_mute=1 \
    ro.kt_incoming_call_flashlight=1 \
    ro.kt_multisim_ringtone=1 \
    ro.kt_no_cast=1 \
    ro.kt_outgoing_call_vibrate=1 \
    ro.kt_pnw_as_mnc=0 \
    ro.kt_preload_locales=0 \
    ro.kt_remove_version_info=1 \
    ro.kt_shutdown_ani=1 \
    ro.kt_shutdown_confirm=1 \
    ro.kt_shutter_sound_switch=1 \
    ro.kt_sms_encode_type=0 \
    ro.kt_sms_sv_number_edit=0 \
    ro.kt_speed_dial_support=1 \
    ro.kt_time_format=0 \
    ro.kt_usb_default_mtp=1 \
    ro.kt_voice_mail=0 \
    ...
    ro.smartf_call_overturn_silent=no \
    ro.smartf_call_shake_decline=no \
    ro.smartfunc_control=no \
    ro.smartfunc_control_alsps=no \
    ro.smartfunc_control_tp=no \
    ro.sys.sdcardfs=1 \
    ro.telephony.default_network=9,9 \
    ro.telephony.sim.count=2 \
    ro.traffic_digital=1 \
    ro.ussd_ksc5601=0 \
